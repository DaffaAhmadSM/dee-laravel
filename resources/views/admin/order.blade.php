                ...
                <table class="w-full whitespace-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr tabindex="0" class="focus:outline-none  h-16 border border-gray-100 rounded">
                            ...
                            @if ($active == 'pending')
                                <form action="/admin/order/confirm/{{$item->id}}" method="POST">
                                    @csrf
                                    <td class="pl-4">
                                        <button class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-yellow-300 rounded hover:bg-gray-200 focus:outline-none">Confirm Order</button>
                                    </td>
                                </form>
                            @endif
                        </tr>
