    ...
    <!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
        <div class="px-4 md:px-10 py-4 md:py-7">
            <div class="flex items-center justify-between">
                <p tabindex="0" class="focus:outline-none text-base sm:text-lg md:text-xl lg:text-2xl font-bold leading-normal text-gray-800">Reservation Confirm</p>
            </div>
        </div>
                ...
                <table class="w-full whitespace-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr tabindex="0" class="focus:outline-none  h-16 border border-gray-100 rounded">
                            ...
                            @if ($active == 'pending')
                                <form action="/admin/reserve/confirm/{{$item->id}}" method="POST">
                                    @csrf
                                    <td class="pl-4">
                                        <button class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-yellow-300 rounded hover:bg-gray-200 focus:outline-none">Confirm Rental</button>
                                    </td>
                                </form>
                            @endif
                        </tr>
