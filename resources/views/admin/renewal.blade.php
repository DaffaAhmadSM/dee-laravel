                ...
                <table class="w-full whitespace-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr tabindex="0" class="focus:outline-none  h-16 border border-gray-100 rounded">
                            ...
                            @endif
                            <td class="pl-4">
                                <button class="py-3 px-6 focus:outline-none text-sm leading-none text-gray-700 bg-gray-100 rounded">Rp. {{number_format($item->cartDetail->total_price)}}</button>
                            </td>
                            <td class="pl-4">
                            ...
                            @if ($active == 'pending')
                                <form action="/admin/renewal/confirm/{{$item->id}}" method="POST">
                                    @csrf
                                    <td class="pl-4">
                                        <button class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-yellow-300 rounded hover:bg-gray-200 focus:outline-none">Accept Renewal</button>
                                    </td>
                                </form>
                            @endif
                        </tr>
